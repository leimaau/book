...
原本这是我在博客中写的科普文章，受[潮语拼音教程](https://kahaani.github.io/gatian/index.html)的启发，现在集结起来做成书，介绍南宁话的基础知识，所以叫做**南宁话小册子**，最新的更新也只于此处，本小册字同时也作为[**Leimaau‘s Webdict 2.0**](https://leimaau.gitee.io/leimaau-webdict2/)、[**南宁话输入方案**](https://github.com/leimaau/naamning_jyutping)和[**南宁话移动端字词典**](https://github.com/leimaau/naamning-dictionary)的配套教程。
