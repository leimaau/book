...
- 零声母不用字母作标记，如「亚」只拼作aa3[aː˥]。零声母前一般都有喉塞音[ʔ]，为简便起见，[ʔ]一律省去。为了避免零声母[∅]与喉塞音[ʔ]符号的混用，如有文獻用[∅i]表示[ji]，用[ʔi]表示[ʔi]，但有些文獻又用[∅i]表示[ʔi]，用[ji]表示[ji]。此处统一ji[ji]表示[ji]，i[∅i]表示i[ʔi]，只使用零声母[∅]（等价于喉塞音[ʔ]）标记，因为其实真正能发零声母的情况极少，可以等价为喉塞音。
