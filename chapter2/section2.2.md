...
一般的论文材料只研究到广州话的平声、上声的特殊变调即止，虽然需要更多实验研究，但我们可以大胆的猜测，古旧的广州话完整的变调不会单单出现在平、上声，应该包括了去声，它是一个完整的特殊变调体系，已发现的平、上声的变调是早期的遗留，也就是说五度标调法不足以标示早期广州话的变调，应该大胆地采用六度标调法。下面表格列出完整的早期广州话系统。
