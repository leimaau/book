...
3.有些唇音字有文白异读，例如「拂浮妇伏翻攀扳泡（即䅦）蓬（薯类蓬松，俗字蒙/𡁏）𠜱（削也）佊（歪）巴（扒着；巴望）绷（面绷；愈合）絣（俗字掹）坌（灰尘大）笨（钝）披（背，俗字孭）㩧」这些字，文读b-[p-]/p-[pʰ-]，白读m-[m-]。
...
算上上述表格最后一项端组与帮组旁转的例子，综合有：（知组-）端组（-帮组）-泥明母旁转，其中「知-端-泥旁转」的例子指的是「稚-啲-呢」、「𤶠-瘩-𤶸」、「揕」、「䋎」这四个例子。规律主要反映在阴调类上，阳调类较少，以泥母为主，明母较少。2022年滕济民《南宁平话音韵研究》把帮组（非组）、端组（知组）、精组、莊组、章组的旁转现象统称为「清声母鼻化现象」，而林亦《广西粤方言塞音、塞擦音鼻音化小规律所辖字的考察》只发现了双唇清塞音的鼻音化（即帮组的旁转）和清塞擦音的鼻音化（即精莊章组的旁转）这两个规律，并未留意到清塞音的鼻音化（即知端组的旁转）这第三个规律。
...
···啊㖞 aa3 wo3[a33 wɔ33] | ···啊喔1.1（新嘅博物馆现在好靓～、噻时又刮着手～），一般弱读为[ə33 wɔ33]，用于表示提醒
...
句式 | 句首（叹词） | 句末（语气词）
---|---|---
陈述句 | 啊（加强语势）、欸（停顿）、呢（指向）、嗯（答应）、喂（引起注意）、噉啊、噉呢、噉哂呢、噉啊话呢、啲噉嘅··· | 啊、呀、嘅、喇（嘞）、咯、嘛、呢、㖞、哦、嗮（哂）、呗、啲嘅、···啲噉嘅、来、去、来嘅、来到嘅、吖喇、吖嘛、之嘛、啊呢、啊呗、哂呢、哂啊、哂吖喇、嘅啊、嘅话、嘅话亲、亲、先、堕
...
叹词、语气词总的用字为「啊、吖、哦、吗、嘛、啦、喇（嘞）、啰、咯、㖞、先、嘅、嗮（哂）、吧、呗、呢、哎、哟、唷、呜、呼、喂、呵、么、唉、呀、吔、嗯、欸（诶）、哇、堕」。
...
高频使用的为「啊、嗮（哂）、吗、呢、喂、嘅、㖞、吧、呗、哦、先、亲、哎、哟」，老派常用的则加上「呵、么、咯、吖嘛、之嘛、喇（嘞）、堕」。
