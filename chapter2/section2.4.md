...
另有「育」字本调为juk6[jʊk̚˨]，但实际已经完全变调为juk1[jʊk̚˥]，不读本调了。又例如「图画」一词中的「画」字本调waa6[waː˨˨]，实际也完全变调为waa2[waː˧˥]，不读本调了。还有一些非浊声母字也有变调类的文白异读，例如「子表派」等字。
