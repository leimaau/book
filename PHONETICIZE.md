...
- 零声母不用字母作标记，如「亚」只拼作aa3[aː˧]。零声母前一般都有喉塞音[ʔ]，为简便起见，[ʔ]一律省去。为了避免零声母[∅]与喉塞音[ʔ]符号的混用，如有文獻用[∅u]表示[wu]，用[ʔu]表示[ʔu]，但有些文獻又用[∅u]表示[ʔu]，用[wu]表示[wu]。此处统一wu[wu]表示[wu]，u[∅u]表示u[ʔu]，只使用零声母[∅]（等价于喉塞音[ʔ]）标记，因为其实真正能发零声母的情况极少，可以等价为喉塞音。
...
- 特殊地，语气词可以单独使用a[ɐ/ə]，例如「嗮」的语音弱化：嗮slaai3[ɬaːi˧]->嗮laai3[laːi˧]->嘞laa3[laː˧]->嘞la3[lɐ˧]->嘞la3[lə˧]->嘞la2[ə˧˥]。
